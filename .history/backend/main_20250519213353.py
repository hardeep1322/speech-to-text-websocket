...
from google.cloud.speech import RecognitionConfig, StreamingRecognitionConfig, SpeechClient
...
async def websocket_endpoint(websocket: WebSocket, client_id: str):
    ...
    try:
        while True:
            ...
            print(f"Received audio chunk from client {client_id} with size: {len(data)}")
